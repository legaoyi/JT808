...
import com.legaoyi.iov.protocol.upstream.messagebody.Jt808_0101_MessageBody;
 ...
 * @since 2020-06-30
 */
@Component(MessageBodyDecoder.MESSAGE_BODY_DECODER_BEAN_PREFIX + "0101" + MessageBodyDecoder.MESSAGE_BODY_DECODER_BEAN_SUFFIX)
public class Jt808_0101_MessageBodyDecoder implements MessageBodyDecoder {

    @Override
    public MessageBody decode(Object message) throws IllegalMessageException {
        Jt808_0101_MessageBody messageBody = new Jt808_0101_MessageBody();
        try {
