...
import com.legaoyi.iov.protocol.downstream.messagebody.Jt808_8003_MessageBody;
 ...
 * @since 2020-06-30
 */
@Component(MessageBodyEncoder.MESSAGE_BODY_ENCODER_BEAN_PREFIX + "8003" + MessageBodyEncoder.MESSAGE_BODY_ENCODER_BEAN_SUFFIX)
public class Jt808_8003_MessageBodyEncoder implements MessageBodyEncoder {

    @Override
    public byte[] encode(MessageBody message) throws IllegalMessageException {
        try {
            Jt808_8003_MessageBody messageBody = (Jt808_8003_MessageBody) message;
